    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      ...
      <div className="quick-actions-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' }}>
        ...
        <button
          ...
          className="glass-panel"
          style={{
            padding: '1.1rem 1.2rem', borderRadius: '1.1rem', border: '1.5px solid #93c5fd',
        ...
        >
          <div style={{ fontSize: '1.75rem', marginBottom: '0.35rem' }}>🧭</div>
          <div style={{ fontWeight: 800, fontSize: '0.92rem', color: '#1e40af' }}>Hướng Nghiệp ĐH-CĐ</div>
          <div style={{ fontSize: '0.75rem', color: '#2563eb', marginTop: '0.15rem', fontWeight: 600 }}>Top 3 Nguyện vọng & Holland</div>
        </button>
      </div>
