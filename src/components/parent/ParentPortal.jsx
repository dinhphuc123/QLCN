      ...
      <body>
        ...
        <table class="info-table">
          <tr>
            ...
            <td><strong>Mã HS:</strong> ${student.studentCode || '2404766115'}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><strong>Họ tên Mẹ / SĐT:</strong> ${student.motherName || 'Hoàng Thị Loan'} (${student.motherPhone || '0912.xxx.xxx'})</td>
            <td><strong>Họ tên Cha / SĐT:</strong> ${student.fatherName || 'Mai Linh Chí'} (${student.fatherPhone || '0913.xxx.xxx'})</td>
          </tr>
        </table>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem' }}>
        ...
        <div className="glass-panel" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem', fontSize: '0.85rem' }}>
            <div><strong>Họ tên Mẹ:</strong> {student.motherName || 'Hoàng Thị Loan'}</div>
            <div>
              <strong>SĐT Mẹ:</strong>{' '}
              <a href={`tel:${student.motherPhone || '0912345678'}`} style={{ color: '#16a34a', fontWeight: 800, textDecoration: 'none' }}>
                {student.motherPhone || '0912.xxx.xxx'}
              </a>
            </div>
            <div><strong>Họ tên Cha:</strong> {student.fatherName || 'Mai Linh Chí'}</div>
            <div>
              <strong>SĐT Cha:</strong>{' '}
              <a href={`tel:${student.fatherPhone || '0913456789'}`} style={{ color: '#16a34a', fontWeight: 800, textDecoration: 'none' }}>
                {student.fatherPhone || '0913.xxx.xxx'}
              </a>
            </div>
